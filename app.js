...
Book.prototype.toggleReadStatus = function () {
    this.readStatus = this.readStatus == 'not read yet' 
                                        ? 'reading' 
                                        : 'not read yet';
}
...
function submitFormButtonEventHandler(e) {
    e.preventDefault();
...
formSubmitButton.addEventListener('submit', submitFormButtonEventHandler);